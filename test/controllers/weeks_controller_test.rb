...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { class_id: @week.class_id, week_number: @week.week_number, wine_id: @week.wine_id }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { class_id: @week.class_id, week_number: @week.week_number, wine_id: @week.wine_id }
    assert_redirected_to week_path(assigns(:week))
  end
